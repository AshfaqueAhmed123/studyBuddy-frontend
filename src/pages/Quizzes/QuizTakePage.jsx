  ...
  return (
    <div className='max-w-4xl mx-auto'>
      ...
      <div className='mb-6'>
        ...
        {/* Question card */}
        <div className='bg-white/80 backdrop-blur-xl border-2 border-slate-200 rounded-2xl shadow-xl shadow-slate-200/50 p-5 my-4'>
              ...
              return (
                ...
                >
                  ...
                  <div className={`shrink-0 w-5 h-5 rounded-full border-2 transition-all duration-200 ${isSelected
                    ...
                    : 'border-slate-500 bg-white group-hover:border-emerald-400'
                    }`}>
                    {isSelected && (
