      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-4 border-b border-slate-200/60">
          <div className="flex items-center gap-2 text-emerald-600 font-bold">
            ...
            <h1 className="text-lg">StudyBuddy</h1>
          </div>
        ...
        <div className="px-4 py-4 border-t border-slate-200/60">
          <button
            ...
            className="flex items-center gap-3 w-full px-4 py-2.5 text-sm font-medium text-slate-700 rounded-xl hover:bg-red-50 hover:text-red-600 transition-colors duration-200"
          >
