    ...
    <div className="relative w-full h-72" style={{ perspective: "1000px" }}>
      ...
      >
        ...
        {/* back of the card */}
              ...
              <div
  className="absolute inset-0 w-full h-full bg-gradient-to-br from-emerald-500 to-teal-500
             border border-emerald-400/60 rounded-2xl
...
>
  ...
  <div className="flex items-center justify-between">
    <span className="text-[10px] uppercase tracking-wider text-emerald-100/80">
      Answer
    </span>
  ...
  {/* Flip indicator */}
  <div className="flex items-center justify-center gap-2 text-xs font-medium text-emerald-100/80">
    <RotateCcw className="w-3.5 h-3.5" strokeWidth={2} />
